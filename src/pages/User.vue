<template>
  ...
  <div class="docList">
    <ul>
      <router-link tag="li" to="/car" class="gk-text">
        <i></i>
        <p>去购物车</p>
        <b></b>
        <!-- <span>0</span> -->
     </router-link> 
      <router-link tag="li" to="/column" class="mm-text">
        <i></i>
        <p>返回商城</p>
        <b></b>
        <!-- <span>0</span> -->
      </router-link>
      <router-link tag="li" to="/follow" class="cg-text">
        <i></i>
        <p>看新闻</p>
        <b></b>
        <!-- <span>0</span> -->
...
.content .header{width:6.4rem;height:3.84rem; background:#9e9a95; padding-top:0.4rem;}
...
.docList ul li{ background:#fff;height:1.5rem; border-top:1px solid #bcbbba; border-bottom:1px solid #7b7c7c;}
...
.gk-text p{ float:left; font-size:0.5rem;margin-left:0.29rem; margin-top:0.35rem;}
...
.mm-text p{ float:left; font-size:0.5rem;margin-left:0.35rem; margin-top:0.35rem;}
...
.cg-text p{ float:left; font-size:0.5rem;margin-left:0.29rem; margin-top:0.35rem;}
