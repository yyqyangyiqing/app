<template>
  ...
  <div class="login-box">
    ...
    <div class="login">
      ...
      <router-link to="/reg" class="loginbtn">注册</router-link>
    </div>
    <p class="rsolid"></p>
  </div>
  <ul>
...
export default {
  ...
  reg(){
    ...
    formDate.append('icon',input.files[0])
    ...
    axios({
      ...
      data:formDate
        ...
        res=>{
          // console.log(1)
          res.data.err===0?this.$router.push('/login'):this.errMess=res.data.msg;
...
.content{max-width:6.4rem; margin:0 auto;}
    ...
    .content h1{width:2.18rem;height:0.05rem;  margin:0 auto; margin-top:1.22rem;}
    ...
    .login .loginbtn{margin-left: 0.6rem}
